...
from SmartParkingSystem.CarDetection.CarDetectController import PARKING_TIME, DOUBLE_PARK_TIME
from SmartParkingSystem.CarDetection.config import copy_car_dict
